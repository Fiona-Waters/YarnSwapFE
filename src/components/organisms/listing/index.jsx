        ...
        <Card maxW={72} minW={56} align={"center"} border='4px' p={0} borderColor={'brand.teal'} >
            ...
            <CardBody w={'full'}>
                <List>
                    ...
                    <ListItem borderBottomColor={'brand.blue'} borderBottomWidth={'1px'}>
                        <InfoRow label={"Swappable"} value1={listing?.swappable} />
                    </ListItem>
                    <ListItem borderBottomColor={'brand.blue'} borderBottomWidth={'1px'}>
